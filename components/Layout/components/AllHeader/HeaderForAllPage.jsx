        ...
        <div className="header-top">
          <div className="container">
            ...
            <div className="header-right">
              ...
              >
                <i className="w-icon-account"></i>Daxil ol
              </a>
              <span
                className="delimiter d-lg-show"
                style={{ display: hiddenText }}
              >
                /
              </span>
              <a
              ...
              <div className="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                ...
                <div className="tab-content">
                  ...
                  <div className="tab-pane" id="sign-up">
                    ...
                    <p>
                      Şəxsi məlumatlarınız bu veb-saytda təcrübənizi
                      dəstəkləmək, hesabınıza girişi idarə etmək və məxfilik
                      siyasətimizdə təsvir olunan digər məqsədlər üçün istifadə
                      olunacaq.
                    </p>
        ...
        <div className="header-middle">
          <div className="container">
            <div className="header-left mr-md-4">
              <a
                href="#"
                className="mobile-menu-toggle text-white w-icon-hamburger"
              ...
              <div className="header-call d-xs-show d-lg-flex align-items-center">
                ...
                <div className="call-info d-lg-show">
                  <h4 className="chat font-weight-normal font-size-md text-normal ls-normal text-white mb-0">
                    <a href="mailto:#" className="text-capitalize text-white">
                      Bizə zəng
                    </a>{" "}
                  </h4>
                  <a
                    href="tel:#"
                    className="phone-number font-weight-bolder text-white ls-50"
                  >
                    {phoneNumberItem}
                  </a>
                </div>
                ...
                <div className="dropdown-box">
                  <div className="cart-header">
                    ...
                    <a href="#" className="btn-close">
                      Bağla<i className="w-icon-long-arrow-right"></i>
                    </a>
                  </div>
                    ...
                    >
                      <li>
                        {logoPost.map((item) => (
                          <a href="#">
                            <img
                              src={`http://34.125.5.25${item.icon}`}
                              width="20px"
                              height="20px"
                            />{" "}
                            {item.title}
